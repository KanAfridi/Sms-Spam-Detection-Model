...
# import preprocessing and wordcount function from preprocessing file
...
# 4. The predictions button for the webapp
if st.button('Predict'):
    ...
    if num_words:
        ...
        prediction = (proba >= 0.75).astype(int) # i'm gonna use probability more than 75 for a good precision 
